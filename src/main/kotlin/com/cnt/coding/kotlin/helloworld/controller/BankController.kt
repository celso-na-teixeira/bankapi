...
import com.cnt.coding.kotlin.helloworld.service.BankService
...
class BankController (private val bankService: BankService) {
    ...
    fun handlerBadRequest(e: IllegalArgumentException): ResponseEntity<String> = ResponseEntity(e.message, HttpStatus.BAD_REQUEST)
    ...
    fun deleteBank(@PathVariable accountNumber: String): Unit = bankService.delete(accountNumber)
